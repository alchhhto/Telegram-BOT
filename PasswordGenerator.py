    ...
    def check(password):
        ...
        while True:
            if len(password) <= 8:
                ...
                return "Получилось очень хорошо! Вы молодец) Вернитесь в главное меню"
                break

        if not flag:
            return "Пароль не подходит под описание сложного :( В следующий раз у Вас обязательно получится! Вернитесь в главное меню"
